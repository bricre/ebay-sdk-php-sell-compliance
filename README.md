# (Unofficial) eBay API client (PHP) - Sell / Compliance
...
Starting from version 1.4.1, this project will match according eBay API's versioning. Should you found a matching 
...
Client::configure(
    new \GuzzleHttp\Client([
        'base_uri' => 'https://api.ebay.com/sell/compliance/v1/',
        'headers'=>[
